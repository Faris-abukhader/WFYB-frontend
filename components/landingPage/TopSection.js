        ...
        <div>
            <div className='relative flex items-center justify-around h-fit px-4 overflow-hidden'>
                <div className='w-1/2 space-y-3 md:space-y-4 lg:space-y-5'>
                    <h1 className='animate__animated animate__fadeIn animate__slower text-lg md:text-3xl lg:text-6xl font-bold'>SYHM 5250 VR BOX Smart Phone VR Box</h1>
                    <p className='animate__animated animate__fadeInUp animate__slow text-xs md:text-md lg:text-lg text-gray-600 w-1/2 border-l-2 px-2 border-green-500'>WFYB is changing the way people and companies work.</p>
                    <div className='flex items-center space-x-3'>
                        <button className='animate__animated animate__fadeInLeft animate__slow bg-green-500 hover:bg-green-600 transition-colors duration-300 rounded-2xl px-3 py-1 md:px-5 md:py-2 text-xs md:text-sm lg:text-md text-zinc-50'>Explore Projects</button>
            ...
            <div style={{ backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundSize: '100% 90%' }} className={`flex items-center justify-between bg-green-500 px-4 bg-[url('/images/topSectionBackgroundAsset.png')] object-contain w-full h-[100px]  md:h-[150px] lg:h-[200px]`}>
                <div className='text-md md:text-2xl lg:text-4xl text-zinc-100 font-bold'>Ready to Raise Funds for Idea?</div>
