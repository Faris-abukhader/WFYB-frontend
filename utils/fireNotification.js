...
const fireNotification = ({label,icon='success'||'error'||'warning'||'info'||'question',hasHandler=false,handler,confirmActionLabel='',deniedActionLabel='',showConfirmButton=false,showCancelButton=false,showConfirmDialog=false,showDeniedDialog=false})=>{
    Swal.fire({
        icon,
        title: label,
        showConfirmButton,
